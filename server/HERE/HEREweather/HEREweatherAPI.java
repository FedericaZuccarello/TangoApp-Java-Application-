...
public class HEREweatherAPI{
	...
	public String sendGet(String citta) throws Exception {
            String url = "https://weather.cit.api.here.com/weather/1.0/report.json?product=forecast_astronomy&name="+ citta +"&app_id="+new ApplicationCredentials().getAPP_ID()+"&app_code="+new ApplicationCredentials().getAPP_CODE()+"&language=it";
